...
public class Task1 extends State{
    ...
    public void update(float dt) {
        ...
        /*
        for(Tube tube : tubes){
            //Checks if tube is off the left side of the screen
            ...
            if(tube.collides(bird.getBounds())){
                ...
                break; //Necessary for iterator to work properly
            }
        }
    ...
    public void render(SpriteBatch sb) {
        //sb.setProjectionMatrix(cam.combined); //Adjusts spritebatch so it knows the coordination system
        sb.begin();
